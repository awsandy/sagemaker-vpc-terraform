...
resource "aws_vpc_endpoint" "vpce-monitoring" {
  policy = jsonencode(
    {
      Statement = [
        {
...
resource "aws_vpc_endpoint" "vpce-sm-api" {
  policy = jsonencode(
    {
      Statement = [
        {
...
resource "aws_vpc_endpoint" "vpce-sm-runtime" {
  policy = jsonencode(
    {
      Statement = [
        {
...
resource "aws_vpc_endpoint" "vpce-sm-notebook" {
  policy = jsonencode(
    {
      Statement = [
        {

...
# aws_iam_policy.studio-vpc-infra-IAM-SageMakerNotebookInstancePolicy:
resource "aws_iam_policy" "studio-vpc-infra-IAM-SageMakerNotebookInstancePolicy" {
  description = "SageMaker Notebook restricted access"
  name        = "studio-vpc-infra-IAM-SageMakerNotebookInstancePolicy"
  path        = "/"
  policy = jsonencode(
    {
      Statement = [
